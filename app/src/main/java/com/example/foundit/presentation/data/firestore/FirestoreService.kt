...
interface FirestoreService {
    ...
    suspend fun addCardData(cardType: Int, parentCategory: String, cardDescription: String, color: String, locationCoordinates: LatLng, locationAddress: String, childCategory: String, date: String)
